...
def argparser():
    ...
    # for a single GPU.
    ## for train prama
    P.add_argument('--train-batch', type=int, default=40, help='minibatch size') #default batch size is changed from 10n to 40 in both train and validation set.
    P.add_argument('--val-batch', type=int, default=40, help='minibatch size')
    ...
    P.add_argument(
        '--nFeats', type=int, default=256, help='block width (number of intermediate channels)')  #default resolution is changed from 256 to 384.  
